    ...
    for i in range(len(lst_batch)):
        ...
        if batch[-1] == 'o':
            ...
            for doc1, doc2, l in dps:
                k1, intervals1, target_inte1, lst_emb1, k2, intervals2, target_inte2, lst_emb2 = process_example(args, h, t, doc1, doc2, tokenizer, args.seq_len, redisd, args.no_additional_marker, args.mask_entity, sent_model)
